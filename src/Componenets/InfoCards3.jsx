...
export default function SimpleCard3() {
  return (
    <section className="p-2 my-2 max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-4">
      <Card className="bg-[#28282b] dark:bg-white dark:shadow-[0_0_10px_black] flex-1">
      ...
      <section className="flex flex-col gap-2 flex-1">
          ...
          <CardBody>
            <div className="flex justify-between mb-2">
              <Typography
                variant="h5"
                color="white"
                className="mb-2 flex gap-2 place-items-center dark:text-black"
              >
          ...
          <CardFooter className="pt-0 pb-2 flex justify-end">
            <Link to="/Projects">
              <Button className="bg-transparent">
                <ArrowRightCircleIcon className="h-8 w-8 text-white dark:text-black hover:text-blue-500 hover:scale-125 ease-in duration-100" />{" "}
              </Button>
            </Link>
          </CardFooter>
        </Card>
        ...
        <Card className="bg-[#28282b] dark:bg-white dark:shadow-[0_0_10px_black] basis-1/2">
          ...
          <CardFooter className="pt-0 pb-2 flex justify-end">
            <Link to="#">
              <Button className="bg-transparent">
                <ArrowRightCircleIcon className="h-8 w-8 text-white dark:text-black hover:text-blue-500 hover:scale-125" />
              </Button>
            </Link>
          </CardFooter>
        </Card>
